...
if (isset($_POST["update"])) {
    ...
    if (!in_array($ext, $ekstensi)) {
        header("location:vivo_detail.php?id_buku=$id_buku&alert=file_extension_not_allowed");
        ...
        if ($ukuran < 3044070) {
            ...
            move_uploaded_file($_FILES['gambar']['tmp_name'], 'cover/' . $rand . '_' . $filename);
            mysqli_query($koneksi, $query);
            header("location:vivo_detail.php?id_buku=$id_buku&alert=success");
        } else {
            header("location:vivo_detail.php?id_buku=$id_buku&alert=file_size_exceeded");
        }
    }
}
...
<html>
    ...
    <body>
        <nav class="navbar navbar-dark bg-dark p-3">
            <a href="Ara_Home.php"><img src='logo-ead.png' style='height:30px;width:auto;' /></a>
            <a type="button" class="btn btn-primary" href='Ara_tambahBuku.php'>Tambah Buku</a>
        </nav>
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <input type="hidden" name="id_buku" value="<?= $select["id_buku"] ?>">
                                    ...
                                    <div class="form-group">
                                        <label class='title'>Penulis</label>
                                        <input type="text" id='penulis_buku' name='penulis_buku' class="form-control" value="Ara_1202194034" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label class='title'>Tahun Terbit</label>
                                    ...
                                    <div class="form-group">
                                        <label class='title'>Deskripsi</label>
                                        <textarea class="form-control" id="deskripsi" name="deskripsi" rows="3" er="Contoh: Buku ini menjelaskan tentang ..."><?= $select['deskripsi']?></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label class='title pr-5'>Bahasa</label>
                                        <?php if ($select["bahasa"] == "Indonesia") : ?>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="bahasa" id="inlineRadio1" value="Bahasa Indonesia" checked>
                                                <label class="form-check-label" for="inlineRadio1">Bahasa Indonesia</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                        ...
                                        <?php else : ?>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="bahasa" id="inlineRadio1" value="Bahasa Indonesia">
                                                <label class="form-check-label" for="inlineRadio1">Bahasa Indonesia</label>
                                            </div>
                                            <div class="form-check form-check-inline">
        ...
        <?php endwhile; ?>
        <div class="footer">
                <img src='assets/ead.png'>
                <h4>Perpustakaan EAD</h4>
                <h3>Ara_1202194034</h3>
            </div>
    </body>
</html>